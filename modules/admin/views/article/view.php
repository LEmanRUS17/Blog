...
<div class="article-view">
    ...
    <p>
        ...
        <?= Html::a('Добавить / Изменить изображение', ['set-image', 'id' => $model->id], ['class' => 'btn btn-primary']) ?>
        <?= Html::a('Добавить / Изменить категорию', ['set-category', 'id' => $model->id], ['class' => 'btn btn-primary']) ?>
